...
** Todo
  ...
  * choose and add additional attributes to events index
  * add more detailed attrs to event show?
  * Sort out event detail collapse / expand
  * User "sign in" -- entering details to localstorage?
  * Marking an event as attending??
